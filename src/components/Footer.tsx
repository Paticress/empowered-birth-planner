        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/guia-gratuito" className="text-maternal-700 hover:text-maternal-600 transition-colors">
                  Guia Gratuito
                </Link>
              </li>
              <li>
                <Link to="/plano-personalizado" className="text-maternal-700 hover:text-maternal-600 transition-colors">
                  Plano Personalizado
                </Link>
              </li>
              <li>
                <Link to="/depoimentos" className="text-maternal-700 hover:text-maternal-600 transition-colors">
                  Depoimentos
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="flex space-x-4 mt-4">
              <a href="#" className="text-maternal-700 hover:text-maternal-600 transition-colors">
